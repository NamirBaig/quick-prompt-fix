...
import { LanguageSelect, ThemeToggle } from "@/components/top-controls";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Prompt Doctor AI — Score & Optimize Your AI Prompts" },
      { name: "description", content: "Diagnose any ChatGPT, Gemini, Claude or Copilot prompt instantly. Get a health score, an X-ray of what's missing, and a rewritten, optimized prompt." },
      { property: "og:description", content: "Diagnose any ChatGPT, Gemini, Claude or Copilot prompt instantly. Get a health score, an X-ray of what's missing, and a rewritten, optimized prompt." },
      { name: "twitter:description", content: "Diagnose any ChatGPT, Gemini, Claude or Copilot prompt instantly. Get a health score, an X-ray of what's missing, and a rewritten, optimized prompt." },
